...
<div class="page-header mb-4">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted">Gérez les événements de l'école</p>
        </div>
...
<x-admin.table
    ...
    icon="fas fa-list"
    :headers="['Titre', 'Date', 'Lieu', 'Type', 'Capacité']"
>
    @forelse($events as $event)
        <tr>
            ...
            <td class="text-end">
                <div class="actions">
                    <a href="{{ route('admin.events.edit', $event) }}" class="btn btn-success btn-sm" title="Modifier">
                        <i class="fas fa-edit"></i>
                    </a>
                    <form action="{{ route('admin.events.destroy', $event) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet événement ?')" title="Supprimer">
        ...
        <tr>
            <td colspan="6">
                <div class="empty-message">
                    ...
                    <a href="{{ route('admin.events.create') }}" class="btn btn-success mt-3">
                        <i class="fas fa-plus me-2"></i>Ajouter un événement
                    </a>
                </div>
            </td>
